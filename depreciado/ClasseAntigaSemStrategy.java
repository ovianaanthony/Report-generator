...
public class ClasseAntigaSemStrategy {
	...
	public ClasseAntigaSemStrategy(Produto[] produtos, String algoritmo, String criterio, String filtro,
			String argFiltro,
			int format_flags) {
	...
	public static void main(String[] args) {
		...
		if (args.length < 4) {
			...
			System.out.println("\tjava " + ClasseVelhaCapenga.class.getName()
		...
		ClasseVelhaCapenga gdr = new ClasseVelhaCapenga(carregaProdutos(),
				opcao_algoritmo,
				opcao_criterio_ord,
